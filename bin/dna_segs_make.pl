...
dna_segs_make.pl -- making dna_segs table for plotting

=head1 SYNOPSIS

dna_segs_make.pl [flags] > dna_segs.txt
...
dna_segs_make.pl -d CLdb.sqlite -sub I-A 

=head2 Gene cluster info from ITEP

dna_segs_make.pl -d CLdb.sqlite -sub I-A  -I DATABASE.sqlite all_I_2.0_c_0.4_m_maxbit

=head2 No broken loci

dna_segs_make.pl -da CLdb.sqlite -sub I-A -q "AND loci.operon_status != 'broken'"

=head2 Just gene features for I-A subtype loci

dna_segs_make.pl -da CLdb.sqlite -sub I-A -f 'gene'
