...
CLdb_spacersSharedByGroup.pl -- determine spacers specific to groups 

=head1 SYNOPSIS

CLdb_spacersSharedByGroup.pl [flags] < spacers_shared.txt > summary.txt
...
perldoc CLdb_spacersSharedByGroup.pl
