...
dna_segs_formatColor.pl -- reduce the number of colors needed for plotting

=head1 SYNOPSIS

dna_segs_formatColor.pl [flags] < dna_segs_order.txt > dna_segs_order_color.txt
...
perldoc dna_segs_formatColor.pl
...
dna_segs_formatColor.pl < dna_segs_order.txt > dna_segs_order_col.txt

=head2 Branch length cutoff (<= 0.1):

dna_segs_formatColor.pl -t tree.nwk -b 0.1 < dna_segs_order.txt > dna_segs_order_col.txt
