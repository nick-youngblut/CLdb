...
CLdb_getGeneInfo.pl -- get gene & loci (& ITEP cluster) info for >=1 gene (fig.peg format)

=head1 SYNOPSIS

CLdb_getGeneInfo.pl [flags] < tbl_withGeneIds.txt > tbl_of_gene_info.txt
