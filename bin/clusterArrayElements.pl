...
clusterArrayElements.pl -- cluster spacers and DRs at various sequence identity cutoffs

=head1 SYNOPSIS

clusterArrayElements.pl [flags] 
...
Directory where intermediate files are written. [$HOME/clustering/]
...
CLdb --perldoc -- clusterArrayElements.pl
...
are written to '$HOME/clustering/' by default.
