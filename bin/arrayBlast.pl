...
arrayBlast.pl -- BLASTn-short of spacers and/or DRs against >=1 genome in CLdb

=head1 SYNOPSIS

arrayBlast.pl [flags] > blast_hits.xml
...
arrayBlast.pl -d CLdb.sqlite -q unique_spacers.fna > blast_hits.xml

=head2 Blasting all DRs against all genomes in CLdb

array2fasta.pl -d CLdb.sqlite -r -clust > unique_DRs.fna

arrayBlast.pl -d CLdb.sqlite -q unique_DRs.fna > blast_hits.xml

=head2 Blasting all spacers against 1 genome (taxon_name = 'e.coli')

array2fasta.pl -d CLdb.sqlite -clust > unique_spacers.fna

arrayBlast.pl -d CLdb.sqlite -q unique_spacers.fna -taxon_name "e.coli"
