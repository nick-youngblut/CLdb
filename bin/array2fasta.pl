...
array2fasta.pl -- write CRISPR array spacers or direct repeats to fasta

=head1 SYNOPSIS

array2fasta.pl [flags] > array.fasta
...
field in the loci table. To alter this field, see "setSenseStrand.pl".
