...
CLdb_arrayCluster2Info.pl -- get Info on spacer or repeat groups

=head1 SYNOPSIS

CLdb_arrayCluster2Info.pl [flags] < groups.txt > array_info.txt
...
perldoc CLdb_arrayCluster2Info.pl
...
echo 1 | CLdb_arrayCluster2Info.pl -d CLdb.sqlite < groups.txt > array_info.txt

=head2 Get all info for a list of repeat groups

CLdb_arrayCluster2Info.pl -d CLdb.sqlite -r < repeat_groups.txt > array_info.txt

=head2 Get just subtype 'I-B' info for a list of spacer groups > array_info.txt

CLdb_arrayCluster2Info.pl -d CLdb.sqlite -sub I-B < spacer_groups.txt > array_info.txt

=head2 Get info for table of BLAST hits where spacer groups were the query

CLdb_arrayCluster2Info.pl -d CLdb.sqlite < spacer_groups_blastn.txt > array_info.txt
