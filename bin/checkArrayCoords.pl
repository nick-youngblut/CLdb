...
checkArrayCoords.pl -- checking that array start-end in the loci table match with the Spacers & DRs tables

=head1 SYNOPSIS

checkArrayCoords.pl [flags]
...
CLdb --perldoc -- checkArrayCoords.pl
