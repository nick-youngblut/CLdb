...
orderByTree.pl -- needed if plotting a tree with CRISPR loci

=head1 SYNOPSIS

=head2 Ordering 'dna_segs' table

orderByTree.pl [flags] < dna_segs.txt > dna_segs_ordered.txt

=head2 Ordering 'xlims' table

orderByTree.pl [flags] < xlims.txt > xlims_ordered.txt
...
orderByTree.pl -t tree.nwk < dna_segs.txt > dna_segs_ordered.txt

=head3 Ordering the complemenary xlims table

orderByTree.pl -t tree.nwk -x < xlims.txt > xlims_ordered.txt
