...
positionByScaffold.pl -- Convert positional values from a scaffold-merged (1 scaffold) to multi-scaffold 

=head1 SYNOPSIS

positionByScaffold.pl [Flags] < Loci.txt > Loci_byScaf.txt
...
CLdb --perldoc -- positionByScaffold.pl
