...
CLdb_spacersShared.pl -- write a matrix of spacers shared among taxa, subtypes, and/or loci

=head1 SYNOPSIS

CLdb_spacersShared.pl [flags] > shared.txt
...
CLdb_spacersShared.pl -d CLdb.sqlite -s > subtype_shared.txt

=head2 Write table of spacers shared among taxa (by taxon_name)

CLdb_spacersShared.pl -d CLdb.sqlite -n > taxa_shared.txt

=head2 Write table of spacers shared among subtypes/taxa

CLdb_spacersShared.pl -d CLdb.sqlite -s -n > subtype_taxa_shared.txt

=head2 Write table of spacers shared among loci (names include taxon_name & subtype)

CLdb_spacersShared.pl -d CLdb.sqlite -l -s -n > loci_subtype-taxa_shared.txt
