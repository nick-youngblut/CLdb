...
xlims_make.pl -- making xlims table for plotting

=head1 SYNOPSIS

xlims_make.pl [flags] > xlims.txt
...
xlims_make.pl -d CLdb.sqlite -sub I-A 

=head2 No broken loci

xlims_make.pl -da CLdb.sqlite -sub I-A -q "AND loci.operon_status != 'broken'"
