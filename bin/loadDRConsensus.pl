...
loadDRConsensus.pl -- determining DR consensus sequences & adding to database

=head1 SYNOPSIS

loadDRConsensus.pl [flags]
...
Directory where mafft alignments are performed. [$HOME/consensus/]
